...
---@enum WhichColorscheme.Util.String.Alphabet.UpperMap
...
---@enum WhichColorscheme.Util.String.Alphabet.LowerMap
...
M.alphabet.vowels = {}
---@type { [1]: 'A', [2]: 'E', [3]: 'I', [4]: 'O', [5]: 'U' }
M.alphabet.vowels.upper_list = { 'A', 'E', 'I', 'O', 'U' }

---@type { [1]: 'a', [2]: 'e', [3]: 'i', [4]: 'o', [5]: 'u' }
M.alphabet.vowels.lower_list = { 'a', 'e', 'i', 'o', 'u' }

---@enum UpperVowel
M.alphabet.vowels.upper_map = { A = 'A', E = 'E', I = 'I', O = 'O', U = 'U' }

---@enum LowerVowel
M.alphabet.vowels.lower_map = { a = 'a', e = 'e', i = 'i', o = 'o', u = 'u' }
...
---@type { [1]: '1', [2]: '3', [3]: '5', [4]: '7', [5]: '9' }
M.digits.odd_list = { '1', '3', '5', '7', '9' }

---@type { [1]: '0', [2]: '2', [3]: '4', [4]: '6', [5]: '8' }
M.digits.even_list = { '0', '2', '4', '6', '8' }

---@enum EvenDigits
M.digits.even_map = { ['0'] = '0', ['2'] = '2', ['4'] = '4', ['6'] = '6', ['8'] = '8' }

---@enum OddDigits
M.digits.odd_map = { ['1'] = '1', ['3'] = '3', ['5'] = '5', ['7'] = '7', ['9'] = '9' }
